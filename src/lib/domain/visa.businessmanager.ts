...
export const formConfig: FormConfig = {
  ...
  sections: {
    education: [
      ...
      { id: 'dual_degree', type: 'BOOLEAN', faqCount: 2, maxPoints: 5 },
    ],
    job: [
      {
        id: 'experience',
    ...
    position: [
      ...
      { id: 'executive_officer', type: 'BOOLEAN', faqCount: 1, maxPoints: 5 },
    ],
    employer: [
      {
      ...
      { id: 'org_smb', type: 'BOOLEAN', maxPoints: 10 },
      {
      ...
      { id: 'high_rnd_expenses', type: 'BOOLEAN', faqCount: 2, maxPoints: 5 },
      { id: 'growth_field', type: 'BOOLEAN', faqCount: 1, maxPoints: 10 },
    ],
    university: [
      {
        id: 'jp',
      ...
      { id: 'jp_uni_grad', type: 'BOOLEAN', maxPoints: 10 },
      { id: 'uni_ranked', type: 'BOOLEAN', faqCount: 2, maxPoints: 10 },
      { id: 'uni_funded', type: 'BOOLEAN', faqCount: 1, maxPoints: 10 },
      { id: 'uni_partner', type: 'BOOLEAN', maxPoints: 10 },
    ],
    bonus: [
      {
      ...
      { id: 'training_jica', type: 'BOOLEAN', faqCount: 1, maxPoints: 5 },
      { id: 'high_investment', type: 'BOOLEAN', faqCount: 1, maxPoints: 5 },
      {
