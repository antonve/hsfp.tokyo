...
import { matchMaxPoints, matchAny, matchQualificationsWithExtraPoints } from '@lib/domain/matchers'
...
const matchersForVisaA: {
    ...
    RESEARCH_ACHIEVEMENTS: {
        ...
        match: (criteria, allQualifications) => {
            ...
            const threshold = 2
            const bonus = 5
            return matchQualificationsWithExtraPoints(criteria, qualifications, threshold, bonus)
        },
    },
    SPECIAL: {
        criteria: [
